#!/bin/bash
# ABLATION: noAttention — ETTh2 + ETTm1, pl={96,336}
...
# DATA="ETTh2"
# mkdir -p Output/${DATA}/abl_noAttention
# for PL in 96 336; do
#     echo "abl_noAttention | ${DATA} | pl=${PL}"
...
#         --model abl_noAttention --keep_levels all --num_heads 8 \
#         --use_gray_pe 1 --use_log_pe 1 --gray_num_bits 10 --dwc_kernel 5 \
#         --save --model_name abl_noAttention_${DATA}_pl${PL} \
#         --checkpoints test_results/${DATA}/abl_noAttention \
#         2>&1 | tee "Output/${DATA}/abl_noAttention/pl${PL}.txt"
# done

...
# ============================================================================
# SwaveNetV1_2 - ETTh1 Experiments (GPU 5)
# ============================================================================
...
# echo "============================================================"
# echo "SwaveNetV1_2 - ETTh1 on GPU 5"
...
#                 CUDA_VISIBLE_DEVICES=5 python run_long.py \
#                     --data ${DATA} \
...
# echo ""
# echo "============================================================"
# echo "SwaveNetV1_2 - ETTh1 COMPLETE!"
# echo "============================================================"
# echo ""
...
#!/bin/bash
# GPU 6 — db4 + LightSpikformer — ETTh1 (all, detail)
DATA="ETTh1"
...
echo "GPU 6 DONE: db4 ETTh1 x {all,detail} x {96,336} = 4"